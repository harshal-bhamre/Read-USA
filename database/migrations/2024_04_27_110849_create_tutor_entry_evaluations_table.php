...
class CreateTutorEntryEvaluationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tutor_entry_evaluations', function (Blueprint $table) {
            $table->bigIncrements('tutorentry_evaluation_id');
    ...
    {
        Schema::dropIfExists('tutor_entry_evaluations');
    }
}
