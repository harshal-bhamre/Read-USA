...
class CreateStudentExitEvaluationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_exit_evaluations', function (Blueprint $table) {
            $table->id("exit_evaluation_id");
            ...
            $table->string('observation_exit_letter')->nullable();
            $table->string('observation_exit_word')->nullable();
            $table->string('observation_exit_concept')->nullable();
            $table->string('observation_exit_writing')->nullable();
            $table->string('observation_exit_hearing')->nullable();
            $table->string('observation_exit_text_reading')->nullable();
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('student_exit_evaluations');
    }
}
